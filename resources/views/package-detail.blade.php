...
@section('content')
    ...
    <section class="py-14 md:pb-20 pt-5 bg-gradient-to-b from-sky-50 via-white to-white">
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
                ...
                <div data-aos="fade-right">
                    ...
                    <div class="relative overflow-hidden rounded-3xl md:rounded-[35px] shadow-xl md:shadow-2xl group">
                        ...
                        <div class="absolute top-5 md:top-8 left-5 md:left-8">
                            ...
                            <div
                                class="bg-white/90 backdrop-blur rounded-full w-24 h-24 md:w-32 md:h-32 flex flex-col items-center justify-center shadow-lg md:shadow-xl">
                ...
                <div data-aos="fade-left">
                    ...
                    <!-- BADGE -->
                    <span
                        class="inline-flex px-4 py-2 rounded-full bg-blue-100 text-blue-600 font-semibold text-xs md:text-sm mb-5">
                        🌊 Surf Experience
                    </span>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="https://wa.me/{{ $wa }}?text={{ $message }}" target="_blank"
