    ...
    <div class="max-w-7xl mx-auto px-4 py-16 md:py-24">
        ...
        <div class="grid lg:grid-cols-2 gap-10 md:gap-20 items-center">
            ...
            <div data-aos="fade-left">
                ...
                <!-- BADGE -->
                <span class="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 text-blue-600 text-xs md:text-sm font-semibold mb-5 md:mb-6">
                    🌊 Surf School • Tanjung Aan, Lombok
                </span>

                @if($about->subtitle)
                    <p class="uppercase tracking-[0.2em] md:tracking-[0.3em] text-xs md:text-sm font-semibold text-blue-600 mb-3 md:mb-4">
                        {{ $about->subtitle }}
                    </p>
                @endif
...
<section class="max-w-7xl mx-auto mt-12 px-4 pb-20 md:pb-24">
    ...
    <div class="bg-white rounded-2xl md:rounded-[35px] overflow-hidden shadow-xl md:shadow-2xl border border-gray-100">
